...
uint16_t anchors[num_anchors] = {0x6002, 0x6034, 0x6035, 0x6000};     // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[num_anchors] = {0, 7747, 0, 7539};               // anchor x-coorindates in mm
int32_t anchors_y[num_anchors] = {0, 0, 10825, 10637};                  // anchor y-coordinates in mm
int32_t heights[num_anchors] = {2635, 0, 0, 3035};              // anchor z-coordinates in mm
